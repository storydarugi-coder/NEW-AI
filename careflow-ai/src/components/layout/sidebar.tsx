...
const NAV_SECTIONS: NavSection[] = [
  {
    ...
    title: "회사 운영",
    items: [
      { label: "CPA 광고 관리", href: "/internal/cpa", icon: Megaphone, group: "company" },
      { label: "유입 경로 검토", href: "/internal/source-review", icon: Search, group: "company" },
      { label: "유입 경로 규칙", href: "/internal/source-rules", icon: BookOpen, group: "company" },
      { label: "데이터 가져오기", href: "/internal/sync", icon: RefreshCw, group: "company" },
      { label: "CSV Import", href: "/internal/import", icon: Upload, group: "company" },
